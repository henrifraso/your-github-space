// ─────────────────────────────────────────────────────────────────────
// Camada de Ferramentas da Área de Trabalho — OS¹ v1
//
...
function mkSensitive(ctx: WorkspaceToolContext): string | undefined {
  return ctx.isSensitive ? SENSITIVE_NOTICE : undefined;
}
function urgencyWindow(u?: string): string {
...
// ─────────────────────────────────────────────────────────────────────
// Roda o template da tool com o contexto atual e devolve o ToolOutput.
// Hoje é local/fallback; futuramente pode chamar backend, LLM, integrações.
