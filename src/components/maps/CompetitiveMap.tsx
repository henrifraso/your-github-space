  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-h-0 flex gap-3 px-4 pb-4 overflow-hidden">
        ...
        {/* Painel lateral — idêntico ao WorkspacePanel */}
        <div className="w-[400px] flex-shrink-0 h-full bg-[#f0f2f4] dark:bg-[#181818] rounded-2xl overflow-hidden border-[0.5px] border-neutral-200 dark:border-[#2e2e2e] shadow-[0_8px_20px_-4px_rgba(0,0,0,0.22),0_2px_6px_-2px_rgba(0,0,0,0.12)] dark:shadow-[0_10px_24px_-4px_rgba(0,0,0,0.6),0_2px_8px_rgba(0,0,0,0.4)]">
