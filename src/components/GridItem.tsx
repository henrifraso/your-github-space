...
export const GridItem = ({ title, emoji, imageUrl, likes = 0, comments = 0, onClick, layoutId }: GridItemProps) => (
  <motion.div
    layoutId={layoutId}
    onClick={onClick}
    className="relative aspect-square bg-[#fafafa] dark:bg-[#161616] border border-neutral-200 dark:border-[#262626] rounded-2xl cursor-pointer group overflow-hidden transition-all duration-200"
