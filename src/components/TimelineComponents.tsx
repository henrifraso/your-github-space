...
export function TimelineCard({ event, onOpen }: { event: TimelineEvent; onOpen: () => void }) {
  return (
    <motion.div onClick={onOpen}
      className="flex-shrink-0 w-[240px] md:w-auto rounded-2xl border border-neutral-200 dark:border-[#414141] bg-[#fafafa] dark:bg-[#323232] p-6 cursor-pointer transition-all duration-200 hover:bg-neutral-100 dark:hover:bg-neutral-800/50"
      whileTap={{ scale: 0.98 }}
    >
