...
const RELEASE_URL = 'https://github.com/henrifraso/your-github-space/releases/latest';
    ...
    <div className="min-h-screen w-full flex items-center justify-center px-6 py-10 bg-[#0a0a0a] text-white font-sans">
      <div className="w-full max-w-md text-center space-y-7">
        ...
        <p className="text-xs text-neutral-500">
          Acesso via navegador foi descontinuado. Em caso de dúvida, fale com a Codify.
        </p>
      </div>
    </div>
  );
