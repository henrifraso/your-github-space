...
export function MarketMapContent({ open, onClose, competitors, onCompetitorClick }: ContentProps) {
  return (
    <motion.div
      ...
      className="fixed inset-0 z-[190] bg-[#f0f2f4] dark:bg-[#323232] flex flex-col"
    >
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 px-6 py-3 border-t border-neutral-200 dark:border-[#414141] flex-shrink-0">
        {[
