  ...
  return (
    <div className="fixed inset-0 flex items-end md:items-center justify-center" style={{ zIndex }}>
      ...
      <motion.div
        ...
        className={`relative w-full ${maxWidth} bg-white dark:bg-[#1c1c1c] rounded-t-2xl md:rounded-2xl p-6 overflow-y-auto`}
        style={{ height }}
      >
        {children}
      </motion.div>
...
export function CloseButton({ onClose }: { onClose: () => void }) {
  return (
    <button onClick={onClose} className="text-[#8e8e8e] hover:text-[#262626] dark:hover:text-white p-2">
