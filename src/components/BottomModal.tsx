  ...
  return (
    <div className="fixed inset-0 flex items-end md:items-center justify-center" style={{ zIndex }}>
      ...
      <motion.div
        ...
        className={`relative w-full ${maxWidth} bg-[#fafafa] dark:bg-[#161616] rounded-t-2xl md:rounded-2xl p-6 overflow-y-auto border border-transparent dark:border-[#262626]`}
        style={{ height }}
      >
        {children}
      </motion.div>
