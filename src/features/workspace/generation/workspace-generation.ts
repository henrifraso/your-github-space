...
export type BlockKind = 'standard' | 'initial' | 'share' | 'mode' | 'tool' | 'diagnostico' | 'score' | 'browserLauncher' | 'mapLauncher' | 'departmentLauncher' | 'settingsLauncher' | 'profileSwitcher' | 'franchiseSwitcher';
