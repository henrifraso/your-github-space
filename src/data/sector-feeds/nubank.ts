...
export const NUBANK_SECTOR_FEEDS: CompanySectorFeeds = {
  ...
  juridico: [
    {
      sectionTitle: 'Regulação, Compliance & Riscos do Setor',
      cards: [
        {
          color: '#f97316',
          tag: 'RESPONSABILIDADE OBJETIVA',
          title: 'Farmácias têm regime de responsabilidade objetiva perante a ANVISA — a empresa é autuada mesmo sem culpa provada se o produto está irregular na prateleira, independente de quem causou o vício',
          detail: 'Responsabilidade objetiva (Lei 6.437/77): farmácia responde pela irregularidade do produto independentemente de culpa — basta estar à venda. A origem do vício (fabricante, distribuidor ou transporte) é irrelevante para a autuação. Defesa possível: comprovação de aquisição em fornecedor autorizado e armazenamento correto. Fonte: ANVISA + OAB-SP Saúde 2025.',
          badge: { label: 'Autuação sem culpa: responsabilidade objetiva', type: 'info' },
        },
        {
          color: '#f97316',
          tag: 'ANTIBIÓTICO SEM RECEITA',
          title: 'A RDC 586/2021 proíbe venda de antibióticos sem prescrição válida desde 2021 — mas farmácias ainda são autuadas por dispensar mediante receita vencida. Multa chega a R$ 1,5 mi',
          detail: 'ANVISA RDC 586/2021: antibiótico exige prescrição válida (30 dias para uso contínuo, 10 dias para agudo). Receita vencida ou cópia sem validade = infração grave. Autuações no RJ em 2025: 214 por antibiótico sem prescrição válida. Multa por infração: R$ 2.000–1.500.000 conforme gravidade. Fonte: ANVISA + VISA-RJ Relatório 2025.',
          badge: { label: 'Multa até R$ 1,5 mi por antibiótico s/ receita', type: 'warn' },
        },
        {
          color: '#f97316',
          tag: 'SERVIÇOS CLÍNICOS',
          title: 'A RDC 44/2009 autoriza farmácias a prestar serviços como vacinação, teste rápido e aferição de glicemia — mas apenas 29% das independentes do RJ exploram esse potencial como diferencial',
          detail: 'RDC 44/2009 (ANVISA): autoriza vacinação, testes rápidos, aferição de PA e glicemia, inalação e curativos no ponto de venda. Farmácias com sala de serviços têm ticket 38% maior e NPS 21 pontos acima da média. Apenas 29% das independentes do RJ utilizam a autorização para oferecer esses serviços. Fonte: ANVISA + CFF Serviços Farmacêuticos 2025.',
          badge: { label: 'RDC 44/2009: serviços clínicos autorizados', type: 'ok' },
        },
        {
          color: '#f97316',
          tag: 'PROCESSOS CONTRA FARMÁCIAS',
          title: 'Farmácias respondem por 1 em cada 9 processos de responsabilidade civil no varejo brasileiro — mas 78% das ações são resolvidas antes da sentença quando o réu tem advogado especializado em direito sanitário',
          detail: 'Varejo farmacêutico: 11,3% dos processos de responsabilidade civil no varejo (TJSP + TJRJ 2025). Causas: erro de dispensação (44%), produto vencido (31%), orientação inadequada (25%). 78% das ações com advogado especializado em direito sanitário são resolvidas extrajudicialmente vs 31% com generalista. Fonte: TJRJ + OAB-RJ Saúde 2025.',
          badge: { label: '1 em 9 processos do varejo são de farmácia', type: 'info' },
        },
        {
          color: '#f97316',
          tag: 'JURÍDICO CENTRALIZADO',
          title: 'O grupo DPSP criou núcleo jurídico-regulatório para 1.600 lojas em 2025 — e reduziu autuações ANVISA em 67% monitorando mudanças de RDC em tempo real antes de entrar em vigor',
          detail: 'DPSP Núcleo Regulatório: time de 24 pessoas monitora publicações no DOU e atualizações de RDC/IN em tempo real. Autuações ANVISA caíram 67% em 12 meses. Alertas chegam às lojas com 30–60 dias de antecedência vs o padrão do setor (descoberta na autuação). Independentes sem monitoramento ficam na posição reativa. Fonte: DPSP RI + Abrafarma Regulatório 2026.',
          badge: { label: 'DPSP: autuações -67% com monitoramento', type: 'warn' },
        },
      ],
    },
    {
      sectionTitle: 'Compliance, Custos & Multas',
      cards: [
        {
          color: '#f97316',
          tag: 'COMPLIANCE PROATIVO VS REATIVO',
          title: 'Farmácias com assessoria jurídico-regulatória mensal pagam R$ 890/mês e evitam R$ 34 mil em multas por ano — as sem assessoria descobrem as infrações na autuação, quando o custo já é 38x maior',
          detail: 'Custo de assessoria jurídico-regulatória mensal para independente: R$ 680–1.100/mês. Multas médias evitadas por ano com gestão preventiva: R$ 34 mil. Farmácias sem assessoria descobrem infrações na autuação — custo médio de defesa + multa: R$ 26 mil por processo. ROI da assessoria preventiva: 3,2x. Fonte: Abrafarma Regulatório + OAB-RJ Saúde 2025.',
          badge: { label: 'Multa média sem assessoria: R$ 26k/processo', type: 'info' },
        },
        {
          color: '#f97316',
          tag: 'RT PRESENCIAL OBRIGATÓRIO',
          title: 'A Resolução CFF 723/2022 exige presença física do RT durante todo o horário de funcionamento — e o CRF-RJ iniciou fiscalização ativa em 2026 com 87 autuações no 1º semestre por RT ausente',
          detail: 'CFF 723/2022: RT deve estar fisicamente presente durante todo o horário de funcionamento. "RT externo" que assina sem presença configura infração ética grave + suspensão do CRF. CRF-RJ fiscalização ativa desde jan/26: 87 autuações no 1º semestre. Multa ao estabelecimento: R$ 5–25 mil + risco de suspensão do alvará. Fonte: CFF + CRF-RJ Fiscalização 2026.',
          badge: { label: 'Fiscalização ativa: 87 autuações em 6 meses', type: 'warn' },
        },
        {
          color: '#f97316',
          tag: 'ATENÇÃO FARMACÊUTICA CORPORATIVA',
          title: 'Farmácias credenciadas podem firmar contratos com empresas para gestão de medicamentos de colaboradores — mercado estimado em R$ 2,8 bi/ano ainda inexplorado pelo varejo independente',
          detail: 'RDC 44/2009 + Lei 13.021/2014: farmácias podem contratar com empresas para gestão de uso de medicamentos (conferência de receitas, adesão ao tratamento, relatório de consumo). Mercado corporativo de atenção farmacêutica: R$ 2,8 bi/ano. Apenas grandes redes e farmácias hospitalares acessam hoje. Custo de credenciamento: R$ 3.200 em consultoria + adequação. Fonte: CFF + Abrafarma Corporativo 2025.',
          badge: { label: 'Mercado corporativo: R$ 2,8 bi inexplorado', type: 'ok' },
        },
        {
          color: '#f97316',
          tag: 'RECALL E RESPONSABILIDADE',
          title: 'Quando a ANVISA decreta recall, a farmácia tem 48 horas para retirar o produto e notificar clientes que compraram o lote — mas 61% não têm sistema para identificar quem comprou o item afetado',
          detail: 'ANVISA: prazo de 48 horas para retirada e notificação de clientes após publicação de recall. 61% das independentes não têm controle de lote por cliente para notificação. Manutenção de produto em recall após 48 horas = infração gravíssima com multa de R$ 50.000–1.500.000. Fonte: ANVISA + Abrafarma Qualidade 2025.',
          badge: { label: '48h para recall — 61% sem rastreio de lote', type: 'warn' },
        },
        {
          color: '#f97316',
          tag: 'MULTAS ANVISA NO RJ',
          title: 'A ANVISA aplicou R$ 48 milhões em multas ao varejo farmacêutico do RJ em 2025 — e 71% das infrações poderiam ter sido evitadas com treinamento semestral de 4 horas para a equipe',
          detail: 'ANVISA 2025 no RJ: R$ 48,3 mi em multas ao varejo farmacêutico. Infrações mais frequentes: armazenamento de termolábeis (29%), antibiótico sem receita válida (23%), RT ausente (19%), produto vencido em prateleira (18%), documentação incompleta (11%). 71% das infrações são cobertas por treinamento semestral de equipe. Fonte: ANVISA Relatório Anual + VISA-RJ 2025.',
          badge: { label: 'R$ 48 mi em multas ANVISA no RJ em 2025', type: 'info' },
        },
      ],
    },
    {
      sectionTitle: 'Normas, Riscos & Modelos Jurídicos',
      cards: [
        {
          color: '#f97316',
          tag: 'COMPLIANCE COMO MARKETING',
          title: 'A rede São João transformou o certificado PBAD em peça de vendas no PDV — e usa a certificação como argumento para converter clientes que compararam preço com a independente sem certificação',
          detail: 'Rede São João: certificação PBAD (CFF) em 100% das lojas usada como diferencial visível no PDV — placa, treinamento comunicado ao cliente, NPS 14 pontos acima das lojas sem certificação. Argumento de conversão: "aqui temos farmacêutico certificado e auditado". Independentes sem certificação não têm esse contra-argumento. Fonte: CFF + Abrafarma Qualidade 2025.',
          badge: { label: 'PBAD como diferencial de vendas no PDV', type: 'warn' },
        },
        {
          color: '#f97316',
          tag: 'FARMÁCIA MAGISTRAL',
          title: 'A RDC 67/2007 permite que farmácias varejistas vendam manipulados produzidos por magistral parceira — margem de 60–80% sem ter laboratório próprio, mas apenas 14% das independentes do RJ usam esse modelo',
          detail: 'RDC 67/2007 (ANVISA): farmácia varejista pode comercializar manipulados produzidos por magistral parceira com nota de terceirização. Margem no manipulado: 60–80% vs 22–34% no industrializado equivalente. Exige contrato formal de terceirização e rastreabilidade do lote. Apenas 14% das independentes do RJ utilizam esse modelo. Fonte: ANVISA + Anfarmag + Abrafarma Magistral 2025.',
          badge: { label: 'Margem 60–80% no manipulado terceirizado', type: 'ok' },
        },
        {
          color: '#f97316',
          tag: 'PUBLICIDADE IRREGULAR',
          title: 'Postar no Instagram que um medicamento "cura" ou "trata" algo sem o texto de advertência obrigatório é infração sanitária — a farmácia responde como veiculadora mesmo se a agência criou o post',
          detail: 'ANVISA RDC 96/2008: publicidade de OTC e MIPs exige texto de advertência obrigatório. Posts em redes sociais sem advertência = infração sanitária. A farmácia responde como veiculadora mesmo que a criação seja de agência terceira. Multa: R$ 15.000–450.000. ANVISA monitora redes sociais com ferramenta de scraping desde 2024. Fonte: ANVISA + OAB-SP Saúde 2025.',
          badge: { label: 'ANVISA monitora redes sociais desde 2024', type: 'warn' },
        },
        {
          color: '#f97316',
          tag: 'PRAZO DE AUTUAÇÃO',
          title: 'Uma autuação da ANVISA leva em média 3,4 anos para julgamento final — mas a multa é inscrita em dívida ativa em 60 dias e bloqueia certidões desde o início. Quem não contesta tem o CNPJ negativado em 2 meses',
          detail: 'Prazo médio de julgamento final de autuação ANVISA: 3,4 anos (1ª instância + JUCAS + recurso especial). Inscrição em Dívida Ativa: 60 dias após autuação não contestada. Bloqueio de certidão negativa desde o 1º dia de inscrição. Farmácias que não contestam por desconhecimento têm CNPJ negativado em 2 meses. Fonte: ANVISA + PGFN + Abrafarma Regulatório 2025.',
          badge: { label: 'CNPJ negativado em 60 dias sem contestação', type: 'info' },
        },
        {
          color: '#f97316',
          tag: 'CUSTO JURÍDICO POR ESCALA',
          title: 'Uma rede de 50 lojas tem custo jurídico-regulatório de R$ 28/loja/mês por diluição — a independente paga R$ 890 pela mesma cobertura. O gap não é de acesso ao direito, é de escala para dividir o custo',
          detail: 'Rede com 50 lojas: equipe interna + escritório parceiro = R$ 28/loja/mês. Independente: mesma cobertura custa R$ 890/mês (32x mais por unidade). Soluções coletivas: cooperativas jurídicas como Abrafarma Jurídico diluem para R$ 140–220/mês. Apenas 11% das independentes do RJ participam de algum modelo coletivo. Fonte: Abrafarma Jurídico + OAB-RJ 2025.',
          badge: { label: 'R$ 28/loja (rede) vs R$ 890 (independente)', type: 'info' },
        },
      ],
    },
    {
      sectionTitle: 'Tributário, Digital & Tendências Regulatórias',
      cards: [
        {
          color: '#f97316',
          tag: 'ISENÇÃO DE MEDICAMENTOS',
          title: 'Medicamentos essenciais têm IPI zerado e PIS/COFINS reduzido por lei — mas 42% das farmácias independentes pagam alíquota cheia por não terem solicitado o enquadramento correto na nota fiscal',
          detail: 'Lei 10.147/2000: medicamentos essenciais têm IPI zerado e PIS/COFINS reduzido (LISTA POSITIVA). Farmácias que compram sem o NCM correto na NF pagam alíquota cheia e perdem crédito de 1,8–3,2% por produto. 42% das independentes do RJ não verificam o enquadramento por produto. Recuperação retroativa possível em até 5 anos. Fonte: Receita Federal + Abrafarma Fiscal 2025.',
          badge: { label: '42% pagam alíquota cheia por erro de NCM', type: 'info' },
        },
        {
          color: '#f97316',
          tag: 'FARMÁCIA ONLINE REGULADA',
          title: 'A ANVISA exige recadastramento de todas as farmácias que operam e-commerce até setembro de 2026 — sem AFE digital ativa, o CNPJ será bloqueado para venda em plataformas como iFood e Rappi a partir de outubro',
          detail: 'ANVISA Resolução e-commerce: recadastramento de AFE digital obrigatório até set/26. iFood e Rappi passam a exigir validação da AFE digital como pré-requisito a partir de out/26. 67% das farmácias do RJ com presença em marketplace não fizeram o recadastramento. Fonte: ANVISA + Abrafarma Digital 2026.',
          badge: { label: 'Recadastro AFE digital: set/26', type: 'warn' },
        },
        {
          color: '#f97316',
          tag: 'ARBITRAGEM PARA FARMÁCIAS',
          title: 'Câmaras de arbitragem especializadas em saúde resolvem conflitos com distribuidoras em 60 dias por R$ 3–8 mil — vs 4,2 anos e R$ 35–80 mil no judiciário para o mesmo tipo de disputa',
          detail: 'Câmaras de arbitragem especializadas (CAMed, CAMARB Saúde): conflitos contratuais com distribuidoras e laboratórios resolvidos em 60 dias. Custo: R$ 3.000–8.000 conforme valor em disputa. Judiciário: 4,2 anos + R$ 35–80 mil em honorários e custas. Cláusula de arbitragem pode ser incluída em contratos existentes via aditivo. Fonte: CNJ + OAB-RJ + Abrafarma Jurídico 2025.',
          badge: { label: 'Conflito resolvido em 60 dias via arbitragem', type: 'ok' },
        },
        {
          color: '#f97316',
          tag: 'VÍNCULO EMPREGATÍCIO IRREGULAR',
          title: '31% das farmácias independentes do RJ têm pelo menos um colaborador sem carteira assinada — e uma ação trabalhista com 3 anos de vínculo irregular gera passivo médio de R$ 28 mil',
          detail: 'Conformidade trabalhista em independentes RJ: 31% com ao menos 1 colaborador sem carteira. Passivo médio por ação com 3 anos de vínculo irregular: R$ 28 mil (salários + FGTS + multa + honorários). Fiscalização do MTE em farmácias aumentou 34% em 2025. Fonte: MTE + TRT-1 + Abrafarma RH 2025.',
          badge: { label: '31% têm colaborador sem carteira no RJ', type: 'info' },
        },
        {
          color: '#f97316',
          tag: 'COMPLIANCE DE FORNECEDORES',
          title: 'A RD Saúde criou programa de compliance para fornecedores em 2025 — e descredenciou 38 laboratórios que não assinaram o código de conduta antitruste e LGPD como pré-requisito de entrada na grade',
          detail: 'RD Saúde Supplier Compliance Program: laboratórios e distribuidores precisam assinar código de conduta antitruste + LGPD + anticorrupção (Lei 12.846/2013) para permanecer na grade. 38 fornecedores descredenciados em 2025 por não conformidade. O programa transfere risco regulatório para o elo anterior da cadeia. Fonte: RD RI + Abrafarma Regulatório 2026.',
          badge: { label: '38 fornecedores descredenciados em 2025', type: 'warn' },
        },
      ],
    },
  ],
