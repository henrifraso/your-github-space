...
export default function App() {
  ...
  useEffect(() => {
    ...
    document.body.style.backgroundColor = dark ? '#323232' : '#fafafa';
  }, [dark]);
  ...
  return (
    <div className={dark ? 'dark' : ''}>
      ...
      <nav className="sticky top-0 z-50 bg-white/80 dark:bg-[#2d2d2d]/80 backdrop-blur-xl border-b border-neutral-100 dark:border-[#414141] py-2.5 sm:py-3 relative">
    ...
    <div
      ...
      className="min-h-screen bg-[#f3f3f3] dark:bg-[#242424] text-neutral-800 dark:text-neutral-100 font-sans lg:pr-[288px] xl:pr-[308px]"
    >
