...
function AuthenticatedApp() {
  ...
  const circleData = useMemo(() => {
    ...
    const descricoes = [
      ...
      fn === 0
        ? 'Nenhum fornecedor mapeado ainda.\nSem dado real conectado neste momento.\nAssim que a mineração de fornecedores entrar, a cobertura aparece aqui.'
  ...
  return (
    ...
    >
      ...
      {isPersonalizedRole(role) && activeSector === 'os1' && !roleConfig.useDefaultSectors && (() => {
        ...
        return (
          <motion.div
            className={`${isSplitView ? SPLIT_TOP_GAP_MT : scrolled ? '' : 'mt-5'} pb-32 space-y-5 pl-5 ${isSplitView ? 'pr-5' : 'pr-[380px]'}`}
            initial="hidden"
            animate="visible"
      ...
      {(activeSector === 'os1' || activeDepartment === 'geral') &&
       ...
       (!isPersonalizedRole(role) || roleConfig.useDefaultSectors ||
        ...
        className={`${scrolled ? '' : 'mt-5'} pb-32 space-y-5 pl-5 ${isSplitView ? 'pr-5' : 'pr-[380px]'}`}
        initial="hidden"
        animate="visible"
